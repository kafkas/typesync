 ...
 * Default values
 */
export const DEFAULT_TS_OBJECT_TYPE_FORMAT = 'interface' satisfies TSObjectTypeFormat;
...
export const DEFAULT_GRAPH_ORIENTATION = 'horizontal' satisfies SchemaGraphOrientation;
